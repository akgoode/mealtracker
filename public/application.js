...
/***/ function(module, exports, __webpack_require__) {
	...
	var mealEvents = __webpack_require__(13);
	var ingEvents = __webpack_require__(38);
	var reqEvents = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mealStore = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hideMeals = function hideMeals() {
	  $('.meal-pill').detach();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateMeal = function onCreateMeal(event) {
	  ...
	  }).then(ui.createMealSuccess).catch(ui.failure);
	};

	var onGetMeals = function onGetMeals(event) {
	  event.preventDefault();
	  api.indexMeals().then(ui.getMealsSuccess).catch(ui.failure);
	};

	var onShowMeal = function onShowMeal(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  api.showMeal(id).then(ui.showMealSuccess).catch(ui.failure);
	};

	var onDestroyMeal = function onDestroyMeal(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  api.destroyMeal(id).then(function () {
	    api.indexMeals().then(ui.getMealsSuccess);
	  }).catch(ui.failure);
	};

	var onUpdateInstructions = function onUpdateInstructions(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.update(data).then(ui.resetMealForm).then(function () {
	    onGetMeals(event);
	  }).then(function () {
	    delete mealStore.meal;
	  }).catch(ui.failure);
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onDestroyMeal: onDestroyMeal,
	  onShowMeal: onShowMeal,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexMeals = function indexMeals() {
	  return $.ajax({
	    url: config.apiOrigin + '/meals/',
	    method: 'GET',
	    headers: {
	...
	var showMeal = function showMeal(id) {
	  return $.ajax({
	...
	var destroyMeal = function destroyMeal(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/meals/' + id,
	    method: 'DELETE',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mealStore = __webpack_require__(12);
	var mealTemplate = __webpack_require__(16);
	var showMealTemplate = __webpack_require__(37);
	var ingEvents = __webpack_require__(38);
	...
	var showMealSuccess = function showMealSuccess(data) {
	  $('#current-meal').detach();
	  var meal = data.meal;
	  var mealCard = showMealTemplate({ meal: meal });
	  $('#show-meal-body').append(mealCard);
	};

	var doneAddingSuccess = function doneAddingSuccess() {
	  $('#add-ing-form').addClass('hide');
	  $('.instructions').removeClass('hide');
	  $('.ingredients').addClass('hide');
	};

	var resetMealForm = function resetMealForm() {
	...
	var getMealsSuccess = function getMealsSuccess(data) {
	  $('.meal-pill').detach();
	  var mealHTML = mealTemplate({ meals: data.meals });
	...
	module.exports = {
	  ...
	  showMealSuccess: showMealSuccess,
	  doneAddingSuccess: doneAddingSuccess,
	  resetMealForm: resetMealForm,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- "
	    + ((stack1 = container.invokePartial(__webpack_require__(36),depth0,{"name":"partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + " -->\n\n<div class=\"meal-pill\" data-id=\""
	    ...
	    + "</h4></p>\n  <p><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-toggle=\"modal\" data-target=\"#show-meal-modal\" type=\"button\" class=\"btn show-meal\">Show</button><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" class=\"btn remove-meal\">Remove</button></p>\n</div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.meals : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div id=\"current-meal\">\n  <div class=\"panel panel-default\">\n    <div class=\"panel-body\">\n      <h3 class=\"show-meal-title\">Name: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</h3>\n      <div class=\"current-ingredients\">\n        <h4>Ingredients</h4>\n        <ul id=\"show-current-ingredients\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.ings : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "        </ul>\n      </div>\n      <div class=\"instructions\">\n        <h4>Instructions</h4>\n        <p id=\"show-instructions\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.instructions : stack1), depth0))
	    + "</p>\n      </div>\n    </div>\n  </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onShowIngredient = function onShowIngredient(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  api.showIngredient(id).then(ui.stageIngredient).catch(ui.failure);
	};

	var onAddIngredient = function onAddIngredient(id) {
	  api.showIngredient(id).then(function (response) {
	    return response;
	  }).catch(ui.failure);
	};

	var onGetAllIngredients = function onGetAllIngredients(event) {
	  event.preventDefault();
	  api.getAllIngredients().then(ui.getAllIngredientsSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showIngredient = function showIngredient(id) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showIngredientsTemplate = __webpack_require__(41);
	...
	var createIngredientFailure = function createIngredientFailure() {
	  $('#ingredients-modal').modal('hide');
	  $('.ingredient-form').val('');
	...
	module.exports = {
	  ...
	  showIngredientSuccess: showIngredientSuccess,
	  getAllIngredientsSuccess: getAllIngredientsSuccess,
	  stageIngredient: stageIngredient,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- "
	    ...
	    + " -->\n\n  <ul data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <li><button class=\"select-ing btn\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + ", "
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.ingredients : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"usePartial":true,"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mealStore = __webpack_require__(12);
	var ing = __webpack_require__(39);

	var onCreateRequirement = function onCreateRequirement(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var id = parseInt(data.requirement.id);
	  if (!isNaN(data.requirement.quantity) && data.requirement.quantity !== '0' && data.requirement.quantity !== '') {
	    ...
	    api.createRequirement(requirement).then(function (response) {
	      ing.showIngredient(id).then(function (ingResponse) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createRequirement = function createRequirement(data) {
	  return $.ajax({
	...
	var showRequirement = function showRequirement(id) {
	  return $.ajax({
	...
	var destroyRequirement = function destroyRequirement(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/requirements/' + id,
	    method: 'DELETE',
	    headers: {
	...
	module.exports = {
	  ...
	  destroyRequirement: destroyRequirement
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ingTemplate = __webpack_require__(45);

	var createRequirementSuccess = function createRequirementSuccess(ingData, reqData) {
	  var ingredient = ingData.ingredient;
	  var requirement = reqData.requirement;
	  var ing = ingTemplate({ ingredient: ingredient, requirement: requirement });
	  $('#current-ingredients').append(ing);
	};

	var createRequirementFailure = function createRequirementFailure() {
	...
	module.exports = {
	  failure: failure,
	  createRequirementSuccess: createRequirementSuccess,
	  createRequirementFailure: createRequirementFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<li class=\"new-ing\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.requirement : depth0)) != null ? stack1.quantity : stack1), depth0))
	    + " "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.ingredient : depth0)) != null ? stack1.unit : stack1), depth0))
	    + " of "
...
/***/ function(module, exports, __webpack_require__) {
	...
	// imports
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Rancho);", ""]);
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Adamina);", ""]);
